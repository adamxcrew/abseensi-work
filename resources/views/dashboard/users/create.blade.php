                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="password" class="form-control @error('password') is-invalid @enderror"
                                            id="password" placeholder="Katasandi pengguna" required name="password">
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="password"
                                            ...
                                            required name="confirmation_password">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('nik') is-invalid @enderror"
                                            ...
                                            value="{{ old('nik') }}" required name="nik" required>
                                ...
                                <div class="col-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror" id="address" placeholder="Alamat pengguna"
                                            required name="address" cols="30" rows="3">{{ old('address') }}</textarea>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control @error('gender') is-invalid @enderror" id="gender"
                                            ...
                                            @foreach ($roles as $gender)
                                                <option value="{{ $gender }}"
                                                    @if (old('gender') == $gender) selected @endif>
                                        ...
                                        <select class="form-control @error('religion') is-invalid @enderror"
                                            ...
                                            @foreach ($roles as $religion)
                                                <option value="{{ $religion }}"
                                                    @if (old('religion') == $religion) selected @endif>
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('marriage') }}" required name="marriage">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('uuid') is-invalid @enderror"
                                            ...
                                            value="{{ old('uuid') }}" name="uuid" disabled>
