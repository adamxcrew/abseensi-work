@extends('layouts.app')
@section('title', 'Ubah Data Jenis Cuti')

@section('title-header', 'Ubah Data Jenis Cuti')
@section('breadcrumb')
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Ubah Data Jenis Cuti</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('timeoff-settings.update', $timeoff->id) }}" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jenis_timeoff') is-invalid @enderror" id="jenis_timeoff"
                                        placeholder="Jenis Cuti" value="{{ old('jenis_timeoff', $timeoff->jenis_timeoff) }}" name="jenis_timeoff">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('description_timeoff') is-invalid @enderror" id="description_timeoff"
                                        placeholder="Deskripsi Jenis Cuti" value="{{ old('description_timeoff', $timeoff->description_timeoff) }}" name="description_timeoff">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('code_timeoff') is-invalid @enderror" id="code_timeoff"
                                        placeholder="Kode Jenis Cuti" value="{{ old('code_timeoff', $timeoff->code_timeoff) }}" name="code_timeoff">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('durasi_timeoff') is-invalid @enderror" id="durasi_timeoff"
                                        placeholder="Durasi Jenis Cuti" value="{{ old('durasi_timeoff', $timeoff->durasi_timeoff) }}" name="durasi_timeoff">
